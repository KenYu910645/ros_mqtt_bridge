...
def main(args):
    ...
    ros_mqtt_bridge = Ros_mqtt_bridge(client_id="mqtt_follower", broker_ip="broker.hivemq.com", port=1883, keepalive=10, clean_session=True)
    ...
    ros_mqtt_bridge.init_tf_subscriber(frame_id = "map", child_id = "base_link_peer",mqtt_topic="mqtt_base_link")    
